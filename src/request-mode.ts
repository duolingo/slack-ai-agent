...
const MODE_TIERS: { triggers: string[]; mode: RequestMode }[] = [
  {
    triggers: [":duo-ai-bot-fast:", "think fast"],
    mode: { model: HAIKU_MODEL },
  },
  {
    triggers: [
      ":duo-ai-bot-think-hardest:",
      "think hardest",
      "try hardest",
      "think harder",
      "try harder",
  ...
  {
    triggers: [":duo-ai-bot-think:", "think hard", "try hard"],
    mode: { effort: "max" },
  },
];
